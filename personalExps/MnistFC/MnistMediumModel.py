...
with open('/baldig/proteomics2/ian/Neural-Balance/personalExps/hist/MediumMnistModelL21e-5Hist.pkl', 'wb') as f:
    pickle.dump(hist, f)

torch.save(model.state_dict(), '/baldig/proteomics2/ian/Neural-Balance/personalExps/models/MediumMnistModelL21e-5.pt')
